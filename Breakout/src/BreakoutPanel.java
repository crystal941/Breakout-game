...
public class BreakoutPanel extends JPanel implements ActionListener, KeyListener {
	...
	private void gameOver() {
		...
		screenMessage = "GAME OVER! Please try again.";
		stopGame();
	}

	private void gameWon() {
		// TODO: Set screen message
		screenMessage = "Congratulations! You win the game!";
		stopGame();
	}
	...
	public void paintComponent(Graphics g) {
		...
		if (livesLeft >= 0) {
			...
			String liveStatus = "Lives Left: " + livesLeft;
			g.drawString(liveStatus, Settings.LIVES_POSITION_X, Settings.LIVES_POSITION_Y);
		}
		// Draw screen message
